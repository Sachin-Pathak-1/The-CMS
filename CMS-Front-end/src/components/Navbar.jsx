...
export function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-30 -mx-3 mb-4 border-b border-[color:var(--border)] bg-[color:var(--card-strong)]/95 px-4 py-3 backdrop-blur-xl md:-mx-4 md:px-6">
            <div className="flex min-h-[64px] items-center justify-between gap-4">
                <div className="min-w-0">
                    <p className="hidden text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400 sm:block">Institution Workspace</p>
                    <div className="mt-1">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link to="/chat" className="icon-button relative">
                        ...
                        {unreadCount > 0 ? (
                            <span className="absolute -top-2 -right-2 flex h-5 min-w-5 items-center justify-center rounded-full bg-red-500 px-1 text-xs text-white">
                                {unreadCount}
                            </span>
                        ) : null}
                    </Link>
                    ...
                    <div className="soft-panel flex items-center gap-3 px-2 py-2">
                        <img
                            src={user?.userDetails?.avatar || "/avatar.png"}
                            alt="profile"
                            width={34}
                        ...
                        <button
                            ...
                            className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500 transition hover:text-red-600"
                        >
                            Logout
                        </button>
                    </div>
